...
type Config struct {
	...
	DefaultProvider        string               `long:"default-provider" env:"DEFAULT_PROVIDER" default:"google" choice:"google" choice:"oidc" choice:"generic-oauth" choice:"b2c" description:"Default provider"`
	...
	CaseInsensitive        bool                 `long:"case-insensitive" env:"CASE_INSENSITIVE" description:"Perform a case insesitive comparison of email addresses on the whitelist"`
